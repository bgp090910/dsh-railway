...
# print notifier bootstrap pairing code (90s after boot, once notifier has written it)
(sleep 90; if [ -f /root/.dsh/dsh-notifier/bootstrap-paircode.txt ]; then echo "PAIRCODE: $(cat /root/.dsh/dsh-notifier/bootstrap-paircode.txt)"; fi) &
